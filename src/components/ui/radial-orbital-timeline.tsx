...
import { ArrowRight, Link, Zap, Calendar } from "lucide-react";
...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-primary/5 via-background to-primary/10 overflow-hidden rounded-lg"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-primary via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10 shadow-lg">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${isExpanded ? "text-primary scale-125" : "text-foreground/70"}
                `}
                >
                  {item.title}
                </div>
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-background backdrop-blur-lg border-primary/30 shadow-xl shadow-primary/10 overflow-visible">
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-6 px-2 py-0 text-xs rounded-none border-primary/20 bg-transparent hover:bg-primary/10 text-foreground hover:text-primary transition-all"
                                  onClick={(e) => {
                                    e.stopPropagation();
